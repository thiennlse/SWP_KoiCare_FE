    ...
    return (
        <div className="admin_dashboard">
            <aside className="sidebar">
                ...
                <nav>
                    <ul>                      
                            <a href="#" onClick={toggleDashboardMenu} className="dashboard_link">
            ...
            <div className="main_content_admin">
                <header className="toolbar">
                    <nav className="toolbar_admin">
                        <a href="#" className="nav_link_admin home_admin">Home</a>
                        <a href="#" className="nav_link_admin">Contact</a>
                        <a href="#" className="logout"><HiOutlineLogout /></a> 
                    </nav>
                </header>
                ...
                <main className="dashboard_content">
                    <div className="dashboard_stats">
                        <div className="stat_card blue">
                            <h3>18</h3>
                            <p>Visitors</p>
                            <a href="#">More info <i className="fas fa_info_circle"></i></a>
                        </div>
